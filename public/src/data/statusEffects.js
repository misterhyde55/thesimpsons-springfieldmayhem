...
export const STATUS_INFO = {
  [STATUS.STRENGTH]: { name: 'Strength', icon: '💪', color: '#d0021b', description: '+1 damage per stack.' },
  [STATUS.ARMOR]: { name: 'Armor', icon: '🛡️', color: '#8c8c99', description: 'Absorbs incoming damage.' },
  [STATUS.WEAK]: { name: 'Weak', icon: '🔻', color: '#8a6aa8', description: '-25% damage dealt.' },
  [STATUS.VULNERABLE]: { name: 'Vulnerable', icon: '💢', color: '#e0642a', description: '+50% damage taken.' },
  [STATUS.DODGE]: { name: 'Dodge', icon: '💨', color: '#3ec24c', description: 'Negates the next attack.' },
  [STATUS.STUN]: { name: 'Stunned', icon: '😵', color: '#f6d217', description: 'Skips their next turn.' },
  [STATUS.RADIATION]: { name: 'Radiation', icon: '☢️', color: '#7cff3a', description: 'Stacks up for radiation-consuming abilities.' },
  [STATUS.POISON]: { name: 'Infected', icon: '🧟', color: '#3ec24c', description: 'Takes damage equal to stacks at turn end, then decays.' },
  [STATUS.TIPSY]: { name: 'Tipsy', icon: '🍺', color: '#e0a04a', description: '+10% damage taken per stack, all battle.' },
};
